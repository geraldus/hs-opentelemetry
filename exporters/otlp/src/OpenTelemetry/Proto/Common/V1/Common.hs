...
newtype AnyValue = AnyValue{anyValueValue ::
                            Hs.Maybe AnyValueValue}
...
instance HsProtobuf.Message AnyValue where
        encodeMessage _ AnyValue{anyValueValue = anyValueValue}
          ...
          = (HsJSONPB.object
               [(let encodeValue
                       = (case f1_or_f2_or_f3_or_f4_or_f5_or_f6_or_f7 of
                              ...
                              Hs.Just (AnyValueValueIntValue f3)
...
instance HsJSONPB.FromJSONPB AnyValue where
        parseJSONPB
          = (HsJSONPB.withObject "AnyValue"
               (\ obj ->
                  (Hs.pure AnyValue) <*>
                    (let parseValue parseObj
                           = Hs.msum
                               [Hs.Just Hs.. AnyValueValueStringValue Hs..
                                ...
                                Hs.Just Hs.. AnyValueValueBytesValue Hs..
...
data AnyValueValue = AnyValueValueStringValue Hs.Text
                 ...
                 (HsJSONPB.NamedSchema{HsJSONPB._namedSchemaName =
                                       ...
                                       HsJSONPB._namedSchemaSchema =
                                         Hs.mempty{HsJSONPB._schemaParamSchema =
                                                   ...
                                                   HsJSONPB._schemaProperties =
                                                     HsJSONPB.insOrdFromList
                                                       [("string_value", anyValueValueStringValue),
                                                        ("bool_value", anyValueValueBoolValue),
                                                        ("int_value", anyValueValueIntValue),
                                                        ("double_value", anyValueValueDoubleValue),
                                                        ("array_value", anyValueValueArrayValue),
                                                        ("kvlist_value", anyValueValueKvlistValue),
                                                        ("bytes_value", anyValueValueBytesValue)],
                                                   HsJSONPB._schemaMinProperties = Hs.Just 1,
                                                   HsJSONPB._schemaMaxProperties = Hs.Just 1}})

newtype ArrayValue = ArrayValue{arrayValueValues ::
...
instance HsProtobuf.Message ArrayValue where
        encodeMessage _ ArrayValue{arrayValueValues = arrayValueValues}
          = (HsProtobuf.encodeMessageField (HsProtobuf.FieldNumber 1)
               (Hs.coerce
                  @(Hs.Vector OpenTelemetry.Proto.Common.V1.Common.AnyValue)
...
instance HsJSONPB.FromJSONPB ArrayValue where
        parseJSONPB
          = (HsJSONPB.withObject "ArrayValue"
               (\ obj ->
                  (Hs.pure ArrayValue) <*>
                    (HsProtobuf.coerceOver
                       @(HsProtobuf.NestedVec OpenTelemetry.Proto.Common.V1.Common.AnyValue)
                 ...
                 (HsJSONPB.NamedSchema{HsJSONPB._namedSchemaName =
                                       ...
                                       HsJSONPB._namedSchemaSchema =
                                         Hs.mempty{HsJSONPB._schemaParamSchema =
                                                   ...
                                                   HsJSONPB._schemaProperties =
                                                     HsJSONPB.insOrdFromList
                                                       [("values", arrayValueValues)]}})

newtype KeyValueList = KeyValueList{keyValueListValues ::
...
instance HsProtobuf.Message KeyValueList where
        encodeMessage _
          KeyValueList{keyValueListValues = keyValueListValues}
          = (HsProtobuf.encodeMessageField (HsProtobuf.FieldNumber 1)
               (Hs.coerce
                  @(Hs.Vector OpenTelemetry.Proto.Common.V1.Common.KeyValue)
...
instance HsJSONPB.FromJSONPB KeyValueList where
        parseJSONPB
          = (HsJSONPB.withObject "KeyValueList"
               (\ obj ->
                  (Hs.pure KeyValueList) <*>
                    (HsProtobuf.coerceOver
                       @(HsProtobuf.NestedVec OpenTelemetry.Proto.Common.V1.Common.KeyValue)
                 ...
                 (HsJSONPB.NamedSchema{HsJSONPB._namedSchemaName =
                                       ...
                                       HsJSONPB._namedSchemaSchema =
                                         Hs.mempty{HsJSONPB._schemaParamSchema =
                                                   ...
                                                   HsJSONPB._schemaProperties =
                                                     HsJSONPB.insOrdFromList
                                                       [("values", keyValueListValues)]}})

data KeyValue = KeyValue{keyValueKey :: Hs.Text,
                         keyValueValue ::
...
instance HsProtobuf.Message KeyValue where
        encodeMessage _
          KeyValue{keyValueKey = keyValueKey, keyValueValue = keyValueValue}
          = ((Hs.mappend
                (HsProtobuf.encodeMessageField (HsProtobuf.FieldNumber 1)
...
data StringKeyValue = StringKeyValue{stringKeyValueKey :: Hs.Text,
                                     stringKeyValueValue :: Hs.Text}
                    deriving (Hs.Show, Hs.Eq, Hs.Ord, Hs.Generic)

instance Hs.NFData StringKeyValue

instance HsProtobuf.Named StringKeyValue where
        nameOf _ = (Hs.fromString "StringKeyValue")

instance HsProtobuf.HasDefault StringKeyValue

instance HsProtobuf.Message StringKeyValue where
        encodeMessage _
          StringKeyValue{stringKeyValueKey = stringKeyValueKey,
                         stringKeyValueValue = stringKeyValueValue}
          = ((Hs.mappend
                (HsProtobuf.encodeMessageField (HsProtobuf.FieldNumber 1)
...
instance HsJSONPB.ToJSONPB StringKeyValue where
        toJSONPB (StringKeyValue f1 f2)
          = (HsJSONPB.object
               ["key" .= (Hs.coerce @(Hs.Text) @(HsProtobuf.String Hs.Text) (f1)),
                "value" .=
                  (Hs.coerce @(Hs.Text) @(HsProtobuf.String Hs.Text) (f2))])
        toEncodingPB (StringKeyValue f1 f2)
          = (HsJSONPB.pairs
               ["key" .= (Hs.coerce @(Hs.Text) @(HsProtobuf.String Hs.Text) (f1)),
                "value" .=
                  (Hs.coerce @(Hs.Text) @(HsProtobuf.String Hs.Text) (f2))])

instance HsJSONPB.FromJSONPB StringKeyValue where
        parseJSONPB
          = (HsJSONPB.withObject "StringKeyValue"
               (\ obj ->
                  (Hs.pure StringKeyValue) <*>
                    (HsProtobuf.coerceOver @(HsProtobuf.String Hs.Text) @(Hs.Text)
                       (obj .: "key"))
...
instance HsJSONPB.ToJSON StringKeyValue where
        toJSON = HsJSONPB.toAesonValue
        toEncoding = HsJSONPB.toAesonEncoding

instance HsJSONPB.FromJSON StringKeyValue where
        parseJSON = HsJSONPB.parseJSONPB

instance HsJSONPB.ToSchema StringKeyValue where
        declareNamedSchema _
          = do let declare_key = HsJSONPB.declareSchemaRef
               stringKeyValueKey <- declare_key Proxy.Proxy
               let declare_value = HsJSONPB.declareSchemaRef
               stringKeyValueValue <- declare_value Proxy.Proxy
               let _ = Hs.pure StringKeyValue <*>
                         (HsProtobuf.coerceOver @(HsProtobuf.String Hs.Text) @(Hs.Text)
                            (HsJSONPB.asProxy declare_key))
                         <*>
                         (HsProtobuf.coerceOver @(HsProtobuf.String Hs.Text) @(Hs.Text)
                 ...
                 (HsJSONPB.NamedSchema{HsJSONPB._namedSchemaName =
                                       ...
                                       HsJSONPB._namedSchemaSchema =
                                         Hs.mempty{HsJSONPB._schemaParamSchema =
                                                   ...
                                                   HsJSONPB._schemaProperties =
                                                     HsJSONPB.insOrdFromList
                                                       [("key", stringKeyValueKey),
                                                        ("value", stringKeyValueValue)]}})

data InstrumentationLibrary = InstrumentationLibrary{instrumentationLibraryName
                                                     :: Hs.Text,
                                                     instrumentationLibraryVersion :: Hs.Text}
                            deriving (Hs.Show, Hs.Eq, Hs.Ord, Hs.Generic)

instance Hs.NFData InstrumentationLibrary

instance HsProtobuf.Named InstrumentationLibrary where
        nameOf _ = (Hs.fromString "InstrumentationLibrary")

instance HsProtobuf.HasDefault InstrumentationLibrary

instance HsProtobuf.Message InstrumentationLibrary where
        encodeMessage _
          InstrumentationLibrary{instrumentationLibraryName =
                                   instrumentationLibraryName,
                                 instrumentationLibraryVersion = instrumentationLibraryVersion}
          = ((Hs.mappend
                (HsProtobuf.encodeMessageField (HsProtobuf.FieldNumber 1)
                   (Hs.coerce @(Hs.Text) @(HsProtobuf.String Hs.Text)
                      (instrumentationLibraryName))))
        ...
        decodeMessage _
          = (Hs.pure InstrumentationLibrary) <*>
              (HsProtobuf.coerceOver @(HsProtobuf.String Hs.Text) @(Hs.Text)
                 (HsProtobuf.at HsProtobuf.decodeMessageField
                    (HsProtobuf.FieldNumber 1)))
              <*>
...
instance HsJSONPB.ToJSONPB InstrumentationLibrary where
        toJSONPB (InstrumentationLibrary f1 f2)
          = (HsJSONPB.object
               ["name" .=
                  (Hs.coerce @(Hs.Text) @(HsProtobuf.String Hs.Text) (f1)),
                "version" .=
                  (Hs.coerce @(Hs.Text) @(HsProtobuf.String Hs.Text) (f2))])
        toEncodingPB (InstrumentationLibrary f1 f2)
          = (HsJSONPB.pairs
               ["name" .=
                  (Hs.coerce @(Hs.Text) @(HsProtobuf.String Hs.Text) (f1)),
                "version" .=
...
instance HsJSONPB.FromJSONPB InstrumentationLibrary where
        parseJSONPB
          = (HsJSONPB.withObject "InstrumentationLibrary"
               (\ obj ->
                  (Hs.pure InstrumentationLibrary) <*>
                    (HsProtobuf.coerceOver @(HsProtobuf.String Hs.Text) @(Hs.Text)
                       (obj .: "name"))
...
instance HsJSONPB.ToJSON InstrumentationLibrary where
        toJSON = HsJSONPB.toAesonValue
        toEncoding = HsJSONPB.toAesonEncoding

instance HsJSONPB.FromJSON InstrumentationLibrary where
        parseJSON = HsJSONPB.parseJSONPB

instance HsJSONPB.ToSchema InstrumentationLibrary where
        declareNamedSchema _
          = do let declare_name = HsJSONPB.declareSchemaRef
               instrumentationLibraryName <- declare_name Proxy.Proxy
               let declare_version = HsJSONPB.declareSchemaRef
               instrumentationLibraryVersion <- declare_version Proxy.Proxy
               let _ = Hs.pure InstrumentationLibrary <*>
                         (HsProtobuf.coerceOver @(HsProtobuf.String Hs.Text) @(Hs.Text)
               ...
               Hs.return
                 (HsJSONPB.NamedSchema{HsJSONPB._namedSchemaName =
                                         Hs.Just "InstrumentationLibrary",
                                       HsJSONPB._namedSchemaSchema =
                                         Hs.mempty{HsJSONPB._schemaParamSchema =
                                                     Hs.mempty{HsJSONPB._paramSchemaType =
                                                                 Hs.Just HsJSONPB.SwaggerObject},
